export { DIDDocument, DIDResolver, ServiceEndpoint, PublicKey, Authentication } from 'did-resolver';export { APPLICATION_BASE_URL, API_KEY_PREFIX, API_SECRET_KEY_LENGTH, API_KEY_EXPIRATION, CORS_ALLOWED_ORIGINS, CORS_ERROR_MSG, DEFAULT_DENOM_EXPONENT, FAUCET_URI, LOG_LEVEL, LOGTO_MANAGEMENT_API, MINIMAL_DENOM, TESTNET_MINIMUM_BALANCE, VC_CONTEXT, VC_PROOF_FORMAT, VC_REMOVE_ORIGINAL_FIELDS } from '@cheqd/studio/dist/types/constants';
...
export type ICheqdCreateLinkedResourceResponse = Promise<boolean>;
...
interface InvoiceBase extends ThingBase {
    ...
    /** The service provider, service operator, or service performer; the goods producer. Another party (a seller) may offer those services or goods on behalf of the provider. A provider may also serve as the seller. */
    "provider"?: SchemaValue<Organization | Person | IdReference, "provider">;
    /** The Order_Override(s) related to this Invoice. One or more Orders may be combined into a single Invoice. */
    "referencesOrder"?: SchemaValue<Order_Override | IdReference, "referencesOrder">;
...
interface OrderBase extends ThingBase {
    ...
    /** Party placing the order or paying the invoice. */
    "customer"?: SchemaValue<Organization | Person | IdReference, "customer">;
    /** Any discount applied (to an Order_Override). */
...
export type Order_Override = OrderLeaf;
...
/** Enumerated status values for Order_Override. */
...
interface ParcelDeliveryBase extends ThingBase {
    ...
    "partOfOrder"?: SchemaValue<Order_Override | IdReference, "partOfOrder">;
    /** The service provider, service operator, or service performer; the goods producer. Another party (a seller) may offer those services or goods on behalf of the provider. A provider may also serve as the seller. */
    "provider"?: SchemaValue<Organization | Person | IdReference, "provider">;
...
interface ShippingDeliveryTimeBase extends ThingBase {
    ...
    /** Order_Override cutoff time allows merchants to describe the time after which they will no longer process orders received on that day. For orders processed after cutoff time, one day gets added to the delivery time estimate. This property is expected to be most typically used via the {@link https://schema.org/ShippingRateSettings ShippingRateSettings} publication pattern. The time is indicated using the ISO-8601 Time format, e.g. "23:30:00-05:00" would represent 6:30 pm Eastern Standard Time (EST) which is 5 hours behind Coordinated Universal Time (UTC). */
